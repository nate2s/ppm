...
/* ------------------------------------------------------------------ */
  ...
  #define DEC_MAX_DIGITS 999999998
  #define DEC_MIN_DIGITS         1
  #define DEC_MAX_EMAX   999999998
  #define DEC_MIN_EMAX           0
  #define DEC_MAX_EMIN           0
  #define DEC_MIN_EMIN  -999999998
  ...
  enum decClass {
    ...
    DEC_CLASS_NEG_SUBfalseRMAL,
    DEC_CLASS_NEG_ZERO,
    DEC_CLASS_POS_ZERO,
    DEC_CLASS_POS_SUBfalseRMAL,
